(function () {
  ...
  (function (_) {
    ...
    try {
      ...
      q("Promise", function (a) {
        ...
        e.prototype.C = function (g) {
          ...
          "function" == typeof h ? this.D(h, g) : this.m(g);
        };
        ...
        e.all = function (g) {
          ...
          return k.done ? c([]) : new e(function (m, n) {
            ...
            do t.push(void 0),
              r++,
              c(k.value).Va(p(t.length - 1), n),
              k = h.next(); while (!k.done);
          });
        };
        return e;
      });
      ...
      q("String.prototype.startsWith", function (a) {
        return a ? a : function (b, c) {
          var d = oa(this, b, "startsWith"), e = d.length, f = b.length;
      ...
      q("Map", function (a) {
        if (
          function () {
            if (
              !a || "function" != typeof a || !a.prototype.entries ||
            ...
            try {
              ...
              n = m.next();
              return n.done || 4 != n.value[0].x || "t" != n.value[1] ||
                  !m.next().done
                ? !1
                : !0;
            } catch (p) {
        ...
        var d = function (h, k) {
            var m = k && typeof k;
            "object" == m || "function" == m
              ? b.has(k) ? m = b.get(k) : (m = "" + ++g, b.set(k, m))
              : m = "p_" + k;
            var n = h.h[m];
            if (n && fa(h.h, m)) {
        ...
        if (
          function () {
            ...
            try {
              ...
              if (
                !d.has(c) || 1 != d.size || d.add(c) != d || 1 != d.size ||
    ...
    try {
      ...
      _.va = function () {
        return _.w("Safari") &&
          !(_.ua() || _.w("Coast") || _.ra() || _.w("Edge") || _.w("Edg/") ||
            _.w("OPR") || _.ta() || _.w("Silk") || _.w("Android"));
      };
      _.ua = function () {
      ...
      _.x = function (a, b) {
        try {
          _.Fa("debug") && window.console && window.console.log &&
            window.console.log(_.Ga(b) + a);
        } catch (c) {}
      };
      _.y = function (a, b) {
        try {
          _.Fa("warn") && window.console && window.console.warn &&
            window.console.warn(_.Ga(b) + a);
        } catch (c) {}
      };
      _.z = function (a, b) {
        try {
          _.Fa("error") && window.console && window.console.error &&
            window.console.error(_.Ga(b) + a);
        } catch (c) {}
      };
      Ia = function (a, b) {
 ...
 SPDX-License-Identifier: Apache-2.0
      */
      ...
      jb = new _.hb(
        _.v.trustedTypes && _.v.trustedTypes.emptyHTML || "",
        0,
        _.gb,
      );
      _.kb = function (a) {
      ...
      _.mb.prototype.ta = !1;
      _.mb.prototype.R = function () {
        this.ta || (this.ta = !0, this.V());
      };
      ...
      var qb = function (a, b) {
        ...
        if (a) {
          ...
          d
            ...
            : (this.i = _.Ua || void 0 !== a.offsetX ? a.offsetX : a.layerX,
              this.j = _.Ua || void 0 !== a.offsetY ? a.offsetY : a.layerY,
          ...
          this.state = a.state;
          this.S = a;
          a.defaultPrevented && qb.ma.preventDefault.call(this);
        }
      };
      _.B(qb, _.nb);
      var pb = { 2: "touch", 3: "pen", 4: "mouse" };
      qb.prototype.stopPropagation = function () {
        qb.ma.stopPropagation.call(this);
        this.S.stopPropagation
          ? this.S.stopPropagation()
          : this.S.cancelBubble = !0;
      };
      qb.prototype.preventDefault = function () {
        qb.ma.preventDefault.call(this);
        var a = this.S;
        a.preventDefault ? a.preventDefault() : a.returnValue = !1;
      };
      qb.prototype.Kc = function () {
        return this.S;
      };
      var rb;
      ...
      wb.prototype.add = function (a, b, c, d, e) {
        ...
        -1 < g
          ? (b = a[g], c || (b.Ua = !1))
          : (b = new ub(b, this.src, f, !!d, e), b.Ua = c, a.push(b));
        return b;
      };
      yb = function (a, b) {
        var c = b.type;
      ...
      wb.prototype.Ha = function (a, b, c, d) {
        a = this.g[a.toString()];
        var e = -1;
        a && (e = xb(a, b, c, d));
        return -1 < e ? a[e] : null;
      ...
      var xb = function (a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
          var f = a[e];
          if (!f.Ia && f.listener == b && f.capture == !!c && f.handler == d) {
            return e;
          }
        }
        return -1;
      };
      var Ab, Bb, Db, Gb, Ib, Lb, Jb, Kb, Nb;
      Ab = "closure_lm_" + (1E6 * Math.random() | 0);
      Bb = {};
      Db = 0;
      _.E = function (a, b, c, d, e) {
        if (d && d.once) return _.Eb(a, b, c, d, e);
        if (Array.isArray(b)) {
        ...
        c = _.Fb(c);
        return _.sb(a)
          ? a.I(b, c, _.Ka(d) ? !!d.capture : !!d, e)
          : Gb(a, b, c, !1, d, e);
      };
      Gb = function (a, b, c, d, e, f) {
        if (!b) throw Error("n");
        var g = _.Ka(e) ? !!e.capture : !!e, h = _.Hb(a);
        h || (a[Ab] = h = new wb(a));
        c = h.add(b, c, d, g, f);
        if (c.proxy) return c;
        d = Ib();
      ...
      _.Eb = function (a, b, c, d, e) {
        if (Array.isArray(b)) {
          for (var f = 0; f < b.length; f++) _.Eb(a, b[f], c, d, e);
          return null;
        }
        c = _.Fb(c);
        return _.sb(a)
          ? a.zb(b, c, _.Ka(d) ? !!d.capture : !!d, e)
          : Gb(a, b, c, !0, d, e);
      };
      Lb = function (a, b, c, d, e) {
        if (Array.isArray(b)) {
          ...
          d = _.Ka(d) ? !!d.capture : !!d,
            c = _.Fb(c),
            _.sb(a)
              ? a.na(b, c, d, e)
              : a && (a = _.Hb(a)) && (b = a.Ha(b, c, d, e)) && _.Mb(b);
        }
      };
      _.Mb = function (a) {
        if ("number" === typeof a || !a || a.Ia) return !1;
        var b = a.src;
        if (_.sb(b)) return yb(b.W, a);
        ...
        Db--;
        (c = _.Hb(b))
          ? (yb(c, a), 0 == c.h && (c.src = null, b[Ab] = null))
          : vb(a);
        return !0;
      };
      Jb = function (a) {
      ...
      _.F.prototype.Ha = function (a, b, c, d) {
        return this.W.Ha(String(a), b, c, d);
      };
      var Pb = function () {};
      Pb.prototype.g = null;
      var Rb;
      ...
      var Zb, bc, jc, cc, ec, dc, hc, fc, kc, nc;
      _.Ub = function (a) {
        ...
        a instanceof _.Ub
          ...
          ? (this.l = !1,
            ...
            _.Xb(this, b[6] || "", !0),
            this.m = Zb(b[7] || ""))
          : (this.l = !1, this.j = new _.ac(null, this.l));
      };
      _.Ub.prototype.toString = function () {
        ...
        if (c = this.i) {
          this.g && "/" != c.charAt(0) && a.push("/"),
            a.push(bc(c, "/" == c.charAt(0) ? dc : ec, !0));
        }
        (c = this.j.toString()) && a.push("?", c);
        (c = this.m) && a.push("#", bc(c, fc));
        return a.join("");
      };
      _.Ub.prototype.resolve = function (a) {
        var b = new _.Ub(this), c = !!a.h;
        c ? _.Vb(b, a.h) : c = !!a.o;
        c ? b.o = a.o : c = !!a.g;
      ...
      _.Xb = function (a, b, c) {
        b instanceof _.ac
          ? (a.j = b, gc(a.j, a.l))
          : (c || (b = bc(b, hc)), a.j = new _.ac(b, a.l));
      };
      _.ic = function (a) {
        return a instanceof _.Ub ? new _.Ub(a) : new _.Ub(a);
      };
      Zb = function (a, b) {
        return a
      ...
      _.l.ba = function (a) {
        ...
        var b = [];
        if ("string" === typeof a) {
          nc(this, a) && (b = b.concat(this.g.get(lc(this, a))));
        } else {
      ...
      _.oc = function (a, b, c) {
        _.mc(a, b);
        0 < c.length &&
          (a.i = null, a.g.set(lc(a, b), _.Ca(c)), a.h += c.length);
      };
 ...
 SPDX-License-Identifier: Apache-2.0
      */
      ...
      _.yc.prototype.set = function (a, b, c) {
        var d = !1;
        if ("object" === typeof c) {
          var e = c.Cb;
          d = c.Db || !1;
      ...
      _.yc.prototype.get = function (a, b) {
        for (
      ...
      _.yc.prototype.Ga = function () {
        return zc(this).keys;
      };
      _.yc.prototype.ba = function () {
      ...
      _.Ac = new _.yc("undefined" == typeof document ? null : document);
    } catch (e) {
      _._DumpException(e);
    }
    try {
      ...
      _.Sc = function (a) {
        if (!Array.isArray(a)) throw Error("N");
        Oc(a, 2);
      };
      Tc = function (a) {
        ...
        switch (typeof a) {
          ...
          case "object":
            if (a && !Array.isArray(a)) {
              if (_.Mc(a)) return Vc(a);
              if (a instanceof _.Wc) {
                var b = a.O;
                b = null == b || "string" === typeof b
                  ? b
                  : Lc && b instanceof Uint8Array
                  ? Vc(b)
                  : null;
                return (a.O = b) || "";
              }
      ...
      ad = function (a, b) {
        if (null != a) {
          if (Array.isArray(a)) a = Zc(a, b);
          else if (Tc(a)) {
            var c = {}, d;
            for (d in a) c[d] = ad(a[d], b);
            a = c;
          } else a = b(a);
          return a;
        }
      ...
      Zc = function (a, b) {
        for (var c = a.slice(), d = 0; d < c.length; d++) c[d] = ad(c[d], b);
        Array.isArray(a) && Pc(a) & 1 && _.Qc(c);
        return c;
      };
      bd = function (a) {
        if (a && "object" == typeof a && a.toJSON) return a.toJSON();
        a = _.Xc(a);
        return Array.isArray(a) ? _.$c(a, bd) : a;
      };
      Yc = function (a) {
        return _.Mc(a) ? new Uint8Array(a) : a;
      };
      gd = function (a, b, c, d, e, f) {
        (a = a.F && a.F[c])
          ? Array.isArray(a)
            ? (e = f.sb ? _.Qc(a.slice()) : a, _.cd(b, c, e))
            : _.dd(b, c, a)
          : (Lc && d instanceof Uint8Array
            ? e = d.length ? new _.Wc(new Uint8Array(d), _.ed) : _.fd()
            : (Array.isArray(d) &&
              (e
                ? _.Sc(d)
                : Array.isArray(d) && Pc(d) & 1 && f.sb && (d = d.slice())),
              e = d),
            _.I(b, c, e));
      };
      _.hd = function (a) {
      ...
      _.jd = function (a) {
        if (a instanceof _.id) return a.g;
        throw Error("V");
      };
      ld = function (a) {
      ...
      _.rd = function (a, b, c, d) {
        ...
        if (_.Ka(b)) {
          if (b instanceof _.nd) {
            if (b.Aa !== od) throw Error("X");
            b = pd(b.toString(), null);
          } else b = qd("zSoyz");
        } else b = qd(String(b));
      ...
      _.xd = function (a, b) {
        ...
        for (
          ...
          do {
            ...
            ) || wd(0 == f[2].length, 0 == g[2].length) || wd(f[2], g[2]);
            f = f[3];
            g = g[3];
          } while (0 == c);
        }
      ...
      Bd = function (a) {
        if (
          !a.h && "undefined" == typeof XMLHttpRequest &&
      ...
      Hd = [];
      Id = function (a) {
        a.u && a.Ib && (a.u.ontimeout = null);
        a.eb && (_.v.clearTimeout(a.eb), a.eb = null);
      };
      Jd = function (a) {
        return _.Ra && Ad() && "number" === typeof a.timeout &&
          void 0 !== a.ontimeout;
      };
      Kd = function (a) {
        a.ub ||
          (a.ub = !0, a.dispatchEvent("complete"), a.dispatchEvent("error"));
      };
      Ld = function (a, b) {
        if (a.u) {
          Id(a);
          var c = a.u, d = a.hb[0] ? function () {} : null;
          a.u = null;
          a.hb = null;
      ...
      _.Od = function (a) {
        ...
        if (!c) {
          if (b = 0 === b) {
            a = String(a.yb).match(_.Sb)[1] || null,
              !a && _.v.self && _.v.self.location &&
              (a = _.v.self.location.protocol.slice(0, -1)),
              b = !Fd.test(a ? a.toLowerCase() : "");
          }
          c = b;
        }
        return c;
      ...
      Pd = function (a) {
        if (
          a.ka && "undefined" != typeof _.Ja &&
          (!a.hb[1] || 4 != Nd(a) || 2 != a.Ya())
        ) {
          if (a.Za && 4 == Nd(a)) Ed(a.ac, 0, a);
      ...
      _.l.send = function (a, b, c, d) {
        if (this.u) throw Error("s`" + this.yb + "`" + a);
        b = b ? b.toUpperCase() : "GET";
        this.yb = a;
        this.ub = !1;
        this.ka = !0;
        this.u = this.ib ? Dd(this.ib) : Dd(_.Qb);
        this.hb = this.ib ? Cd(this.ib) : Cd(_.Qb);
        this.u.onreadystatechange = (0, _.vd)(this.ac, this);
        this.Qc && "onprogress" in this.u &&
          (this.u.onprogress = (0, _.vd)(function (g) {
            this.$b(g, !0);
          }, this),
            this.u.upload &&
            (this.u.upload.onprogress = (0, _.vd)(this.$b, this)));
        try {
          this.wb = !0, this.u.open(b, String(a), !0), this.wb = !1;
        } catch (g) {
          Md(this);
          return;
        }
        ...
        if (d) {
          if (Object.getPrototypeOf(d) === Object.prototype) {
            ...
            "function" === typeof d.keys && "function" === typeof d.get
          ) {
            e = _.u(d.keys());
        ...
        this.cc && (this.u.responseType = this.cc);
        "withCredentials" in this.u && this.u.withCredentials !== this.Jb &&
          (this.u.withCredentials = this.Jb);
        if ("setTrustToken" in this.u && this.Gb) {
          try {
            this.u.setTrustToken(this.Gb);
          } catch (g) {}
        }
        try {
          Id(this),
            0 < this.fb &&
            ((this.Ib = Jd(this.u))
              ? (this.u.timeout = this.fb,
                this.u.ontimeout = (0, _.vd)(this.ec, this))
              : this.eb = Ed(this.ec, this.fb, this)),
            this.Za = !0,
            this.u.send(a),
            this.Za = !1;
        } catch (g) {
      ...
      _.l.V = function () {
        this.u &&
          (this.ka &&
            (this.ka = !1, this.qa = !0, this.u.abort(), this.qa = !1),
            Ld(this, !0));
        Rd.ma.V.call(this);
      };
      _.l.ac = function () {
        this.ta || (this.wb || this.Za || this.qa ? Pd(this) : this.Pc());
      };
      _.l.Pc = function () {
        Pd(this);
      };
      ...
      _.l.getAllResponseHeaders = function () {
        return this.u && 2 <= Nd(this)
          ? this.u.getAllResponseHeaders() || ""
          : "";
      };
      _.Sd = function (a) {
        try {
      ...
      ge = function (a, b) {
        ...
        void 0 === ee && (_.v.Int32Array ? ee = new Int32Array(fe) : ee = fe);
        this.reset();
      };
      _.B(ge, de);
      ge.prototype.reset = function () {
        this.j = this.h = 0;
        this.g = _.v.Int32Array ? new Int32Array(this.l) : _.Ca(this.l);
      };
      var he = function (a) {
        ...
        for (b = 16; 64 > b; b++) {
          ...
          d = c[b - 2] | 0;
          var f = (c[b - 16] | 0) +
                ((e >>> 7 | e << 25) ^ (e >>> 18 | e << 14) ^ e >>> 3) | 0,
            g = (c[b - 7] | 0) +
                ((d >>> 17 | d << 15) ^ (d >>> 19 | d << 13) ^ d >>> 10) | 0;
          c[b] = f + g | 0;
        }
        d = a.g[0] | 0;
        e = a.g[1] | 0;
        ...
        f = a.g[7] | 0;
        for (b = 0; 64 > b; b++) {
          var t = ((d >>> 2 | d << 30) ^ (d >>> 13 | d << 19) ^
                (d >>> 22 | d << 10)) + (d & e ^ d & h ^ e & h) | 0;
          g = m & n ^ ~m & p;
      ...
      ge.prototype.digest = function () {
        var a = [], b = 8 * this.j;
        56 > this.h
          ? this.update(_.db, 56 - this.h)
          : this.update(_.db, this.blockSize - (this.h - 56));
        ...
        if (void 0 === je) {
          ...
          if (d && d.createPolicy) {
            try {
              ...
              _.v.console && _.v.console.error(e.message);
            }
            je = c;
          } else je = c;
        }
        a = (c = je) ? c.createHTML(a) : a;
        return new _.hb(a, b, _.gb);
      };
      qd = function (a) {
        if (a instanceof _.hb) return a;
        var b = "object" == typeof a, c = null;
        b && a.vb && (c = a.Xa());
        a = b && a.ca ? a.Z() : String(a);
        be.test(a) &&
      ...
      _.qe = function (a, b) {
        ...
        if (c.getElementsByClassName) a = c.getElementsByClassName(a)[0];
          ...
          c = document;
          var d = b || c;
          a = d.querySelectorAll && d.querySelector && a
            ? d.querySelector(a ? "." + a : "")
            : oe(c, a, b)[0] || null;
        }
        return a || null;
      ...
      _.xe = function (a) {
        ...
        for (var d = 0; d < b.length; d++) {
          var e = b[d], f = a[d];
          Array.isArray(f) ? _.oc(c, e, f) : c.add(e, f);
        }
        return c;
      };
 ...
 SPDX-License-Identifier: Apache-2.0
      */
        ...
        if (!_.Ae) {
          ...
          for (
            ...
            for (var e = 0; e < d.length; e++) {
              var f = d[e];
              void 0 === _.Ae[f] && (_.Ae[f] = e);
            }
          }
        }
      };
      var Lc;
      Lc = "undefined" !== typeof Uint8Array;
      _.ed = {};
      var Ce;
      _.Wc = function (a, b) {
        if (b !== _.ed) throw Error("J");
        this.O = a;
        if (null !== a && 0 === a.length) throw Error("K");
      };
      _.fd = function () {
        return Ce || (Ce = new _.Wc(null, _.ed));
      };
      _.De = "function" === typeof Uint8Array.prototype.slice;
      _.Ee = {};
      var Nc = "function" === typeof Symbol && "symbol" === typeof Symbol()
        ? Symbol(void 0)
        : void 0;
      var Ie;
      _.Ge = Object.freeze(_.Qc([]));
      _.He = function (a) {
        if (_.Rc(a.H)) throw Error("O");
      };
      Ie = "undefined" != typeof Symbol &&
        "undefined" != typeof Symbol.hasInstance;
      var Je;
      Je = function (a) {
        return a.g || (a.g = a.H[a.h + a.pa] = {});
      };
      _.H = function (a, b, c) {
        return -1 === b
          ? null
      ...
      var Le = function (a, b, c) {
        ...
        a || (a = d ? [d] : []);
        this.pa = (d ? 0 : -1) - (this.constructor.g || 0);
        this.F = void 0;
        this.H = a;
        a: {
          d = this.H.length;
          a = d - 1;
          if (d && (d = this.H[a], Tc(d))) {
            this.h = a - this.pa;
            this.g = d;
            break a;
          }
          void 0 !== b && -1 < b
            ? (this.h = Math.max(b, a + 1 - this.pa), this.g = void 0)
        ...
        if (c) {
          for (b = 0; b < c.length; b++) {
            if (a = c[b], a < this.h) {
              a += this.pa,
                (d = this.H[a])
                  ? Array.isArray(d) && _.Qc(d)
                  : this.H[a] = _.Ge;
            } else {
              d = Je(this);
              var e = d[a];
              e ? Array.isArray(e) && _.Qc(e) : d[a] = _.Ge;
            }
          }
        }
      };
      Le.prototype.toJSON = function () {
        var a = this.H;
        return _.Fe ? a : _.$c(a, bd);
      };
      Le.prototype.sa = function (a) {
        if (a !== _.Ee) throw Error("M");
        return _.Rc(this.H);
      };
      ...
      if (Ie) {
        ...
        Object.defineProperties(
          Me,
          (Ne[Symbol.hasInstance] = Uc(function () {
            throw Error("Q");
          }),
            Ne),
        );
      ...
      _.J(_.O, Me);
      _.O.prototype.Fb = function (a) {
        if (a !== _.Ee) throw Error("M");
        if (_.Rc(this.H)) {
          a = { sb: !0 };
          var b = _.Rc(this.H);
          if (b && !a.sb) throw Error("S");
          var c = new this.constructor();
          this.ra && (c.ra = this.ra.slice());
          for (var d = this.H, e = 0; e < d.length; e++) {
            var f = d[e];
            if (e === d.length - 1 && Tc(f)) {
              for (h in f) {
                var g = +h;
                Number.isNaN(g) ? Je(c)[h] = f[h] : gd(this, c, g, f[h], b, a);
              }
            } else gd(this, c, e - this.pa, f, b, a);
          }
          var h = c;
        } else h = this;
        return h;
      ...
      if (Ie) {
        ...
        Object.defineProperties(
          _.O,
          (Re[Symbol.hasInstance] = Uc(Object[Symbol.hasInstance]), Re),
        );
      }
      _.Te = function (a) {
        _.O.call(this, a, -1, Se);
      };
      _.J(_.Te, _.O);
      var Se = [9];
      _.Ue = function (a) {
      ...
      _.af.prototype.resolve = function (a) {
        if (!this.i) throw Error("T");
        this.i(a);
        this.R();
      };
      _.af.prototype.reject = function (a) {
        if (!this.h) throw Error("T");
        this.h(a);
        this.R();
      };
      _.af.prototype.R = function () {
        this.h = this.i = null;
      };
      /*
 ...
 SPDX-License-Identifier: Apache-2.0
      */
      ...
      _.df = new _.id("about:invalid#zTSz", _.bf);
      _.kd = function (a) {
        this.Nc = a;
      };
      _.ef = [
      ...
      hf.prototype.Aa = od;
      _.jf = function (a, b) {
        return null != a && a.Aa === b;
      };
      var kf, xf, mf, yf, lf, zf, tf, pf, qf;
      kf = function (a) {
        if (null != a) {
          switch (a.rb) {
            case 1:
      ...
      _.Q = function (a) {
        return _.jf(a, od)
          ? a
          : a instanceof _.hb
          ? (0, _.P)(_.ib(a).toString(), a.Xa())
          : (0, _.P)(String(String(a)).replace(lf, mf), kf(a));
      };
      _.P = function (a) {
        function b(c) {
          this.Ba = c;
      ...
      _.nf = function (a) {
        return a instanceof _.nd ? !!a.Ba : !!a;
      };
      _.of = function (a) {
        function b(c) {
          this.Ba = c;
      ...
      _.R = function (a) {
        _.jf(a, od)
          ? (a = String(a.Ba).replace(pf, "").replace(qf, "&lt;"), a = _.rf(a))
          : a = String(a).replace(lf, mf);
        return a;
      };
      _.wf = function (a) {
        _.jf(a, _.ff) || _.jf(a, _.gf)
          ? a = _.sf(a)
          : a instanceof _.D
          ? a = _.sf(_.ne(a))
          : a instanceof _.cf
          ? a = _.sf(_.jd(a))
          : a instanceof _.le
          ? a = _.sf(_.me(a).toString())
          : (a = String(a),
            a = tf.test(a) ? a.replace(_.uf, _.vf) : "about:invalid#zSoyz");
        return a;
      };
      xf = {
        "\x00": "&#0;",
      ...
      _.rf = function (a) {
        return String(a).replace(zf, mf);
      };
      _.sf = function (a) {
        return String(a).replace(_.uf, _.vf);
      };
      pf = /<(?:!|\/?([a-zA-Z][a-zA-Z0-9:\-]*))(?:[^>'"]|"[^"]*"|'[^']*')*>/g;
      qf = /</g;
      /*
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
      */
      ...
      _.Af = function (a) {
        return (0, _.P)(
          (a
            ? '<svg class="' + _.R("Bz112c") + " " + _.R("Bz112c-E3DyYd") +
              " " + _.R("Bz112c-uaxL4e") +
              '" aria-hidden=true viewBox="0 0 192 192">'
            : '<svg class="' + _.R("fFW7wc-ibnC6b-HiaYvf") + " " +
              _.R("zTETae-mzNpsf-Bz112c") + " " + _.R("n1UuX-DkfjY") +
              '" aria-hidden=true viewBox="0 0 192 192">') +
    ...
    try {
      ...
      _.$h = function (a, b, c) {
        ...
        if (b && 2 === b.Nb()) {
          ...
          b && 2 === _.H(b, 10) && !_.$e("disable_personalized_button")
            ? (c = void 0 === c ? !0 : c,
              b && null != _.H(b, 8)
                ? (d = {},
                  b &&
      ...
      var gi = {},
        hi = function (a, b) {
          return a && b && a.Mc && b.Mc
            ? a.Aa !== b.Aa ? !1 : a.toString() === b.toString()
            : a instanceof _.nd && b instanceof _.nd
            ? a.Aa != b.Aa ? !1 : a.toString() == b.toString()
            : a == b;
        },
        ii = function (a) {
        ...
        ji =
          /^(?!-*(?:expression|(?:moz-)?binding))(?:(?:[.#]?-?(?:[_a-z0-9-]+)(?:-[_a-z0-9-]+)*-?|(?:rgb|rgba|hsl|hsla|calc)\([-\u0020\t,+.!#%_0-9a-zA-Z]+\)|[-+]?(?:[0-9]+(?:\.[0-9]*)?|\.[0-9]+)(?:e-?[0-9]+)?(?:[a-z]{1,4}|%)?|!important)(?:\s*[,\u0020]\s*|$))*$/i,
        ki = function (a) {
          _.jf(a, gi)
            ? a = ii(a.Ba)
            : null == a
            ...
            : a instanceof ci
            ? a = ii(
              a instanceof ci && a.constructor === ci
                ? a.g
                : "type_error:SafeStyle",
            )
            : a instanceof ei
            ? a = ii(
              a instanceof ei && a.constructor === ei
                ? a.g
                : "type_error:SafeStyleSheet",
            )
            : (a = String(a), a = ji.test(a) ? a : "zSoyz");
          return a;
        },
        li = function () {
          return (0, _.P)(
      ...
      var qi = function (a, b, c, d, e, f, g, h) {
          g = void 0 === g ? !0 : g;
          h = void 0 === h ? !1 : h;
          var k = e && 1 != e ? _.Q(mi(e)) : _.Q(mi(2));
          var m = _.P;
          g = "<div" + (g ? ' tabindex="0"' : "") +
            ' role="button" aria-labelledby="button-label" class="' +
            _.R("nsm7Bb-HzV7m-LgbsSe") + " " + (h ? _.R("Bz112c-LgbsSe") : "") +
            " ";
          var n = "";
          switch (b) {
            case 2:
          ...
          return m(
            g + _.R(n) + " " + _.R(ni(c)) + " " + _.R(oi(d)) + '"' +
              (_.nf(f) && !h
                ? ' style="width:' + _.R(ki(f)) +
                  'px; max-width:400px; min-width:min-content;"'
                : "") +
              '><div class="' + _.R("nsm7Bb-HzV7m-LgbsSe-MJoBVe") +
              '"></div><div class="' +
              _.R("nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb") + " " +
              (hi(a, 2) ? _.R("oXtfBe-l4eHX") : "") + '">' +
              pi(hi(c, 2) || hi(c, 3)) + (h
                ? ""
                : '<span class="' + _.R("nsm7Bb-HzV7m-LgbsSe-BPrWId") + '">' +
                  _.Q(mi(e)) + "</span>") +
              '<span class="' + _.R("L6cTce") + '" id="button-label">' + k +
              "</span></div></div>",
          );
        },
        ni = function (a) {
        ...
        pi = function (a) {
          return (0, _.P)(
            (void 0 === a ? 0 : a)
              ? '<div class="' + _.R("nsm7Bb-HzV7m-LgbsSe-Bz112c-haAclf") +
                '"><div class="' + _.R("nsm7Bb-HzV7m-LgbsSe-Bz112c") + '">' +
                li() + "</div></div>"
              : '<div class="' +
      ...
      var ai = function (a) {
        ...
        Yh = function (a) {
          var b = a.Fa, c = _.P;
          var d = a.Sc;
          var e = a.Tc, f = a.shape, g = a.text, h = a.theme;
          a = a.width;
          var k = void 0 === b ? !0 : b;
          b = d.Vb ? d.Vb : d.displayName;
          f = "<div" + (void 0 === k || k ? ' tabindex="0"' : "") +
            ' role="button" aria-labelledby="button-label" class="' +
            _.R("nsm7Bb-HzV7m-LgbsSe") +
            " " + _.R("jVeSEe") + " " + _.R(ni(h)) + " " + _.R(oi(f)) +
            '" style="max-width:400px; min-width:200px;' +
            (a ? "width:" + _.R(ki(a)) + "px;" : "") + '"><div class="' +
            _.R("nsm7Bb-HzV7m-LgbsSe-MJoBVe") + '"></div><div class="' +
            _.R("nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb") + '">';
          d.la
            ? (f += '<img class="' + _.R("n1UuX-DkfjY") + '" src="' +
              _.R(_.wf(d.la)) + '" alt="',
              a = _.R(b ? b : d.id) + "'s profile image",
              f += _.rf(a),
              f += '">')
            : f += _.Af();
          a = '<div class="' + _.R("nsm7Bb-HzV7m-LgbsSe-BPrWId") +
            '"><div class="' + _.R("ssJRIf") + '">';
          k = "";
          if (b) {
            switch (g) {
              case 4:
          ...
          f += a + _.Q(k) + '</div><div class="' + _.R("K4efff") +
            '"><div class="' + _.R("fmcmS") + '">' + _.Q(d.id) + "</div>" +
            (1 < e
              ? (0, _.P)(
                '<svg class="' + _.R("Bz112c") + " " + _.R("Bz112c-E3DyYd") +
              ...
              : "") +
            "</div></div>" + pi(hi(h, 2) || hi(h, 3)) + "</div></div>";
          d = (0, _.P)(f);
          return c(d);
        };
    } catch (e) {
 ...
 SPDX-License-Identifier: Apache-2.0
      */
      _.Fi = function () {
        return (_.w("iPad") || _.w("iPhone")) && !_.va() && !_.ua() &&
          !_.w("Coast") && !_.ta() && _.w("AppleWebKit");
      };
      _.Ii = function () {
        return ![_.ua() && !_.Gi() && !_.Hi(), _.ua() && _.wa(), _.w("Edge")]
          .some(function (a) {
            return a;
          });
      };
    ...
    try {
      _.Lk = function (a) {
        return a instanceof _.cf ? _.jd(a) : _.ne(a);
      };
      _.Mk = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;
    } catch (e) {
      _._DumpException(e);
    }
    try {
      ...
      _.Rk = function (a) {
        var b = void 0 === b ? _.ef : b;
        a: {
          b = void 0 === b ? _.ef : b;
          for (var c = 0; c < b.length; ++c) {
            var d = b[c];
            if (d instanceof _.kd && d.Nc(a)) {
              a = new _.id(a, _.bf);
              break a;
            }
          }
      ...
      _.Pk = function (a) {
        ...
        _.Mk.test(a) || (a = "about:invalid#zClosurez");
    ...
    try {
      ...
      _.nl = function (a, b) {
        ...
        d = a;
        d instanceof _.D ||
          (d = "object" == typeof d && d.ca ? d.Z() : String(d),
            _.Mk.test(d)
              ? d = new _.D(d, _.eb)
              : (d = String(d).replace(/(%0A|%0D)/g, ""),
                d = d.match(ml) ? new _.D(d, _.eb) : null));
        b = b.Z();
        b = window.open(_.Lk(d || _.fb), b, c);
        if (
          !b ||
          b.closed || "undefined" === typeof b.closed
        ) {
          return _.z(
            "Failed to open popup window on url: " + a +
      ...
      _.pl.prototype.ca = !0;
      _.pl.prototype.Z = function () {
        return this.g;
      };
      ml = /^data:(.*);base64,[a-z0-9+\/]+=*$/i;
      _.ql = function (a, b, c) {
        _.We(a, {
          timestamp: (new Date()).getTime(),
          type: "ui_change",
 ...
 SPDX-License-Identifier: Apache-2.0
      */
              ...
              if (g) {
                ...
                switch (g) {
                  ...
                  case "num":
                    ...
                    isNaN(e)
                      ? _.z(
                        "Expected a number for '" + d +
                          "'. Configuration ignored.",
                      )
                      : c[f] = e;
                    break;
                  case "func":
                    "function" === typeof h[e] ? c[f] = h[e] : _.z(
                      "The value of '" + d +
      ...
      _.xm = function () {
        ...
        if (_.xc && !_.ya()) return wm(/Version\/([0-9.]+)/);
        if (_.tc || _.uc) {
          if (a = /Version\/(\S+).*Mobile\/(\S+)/.exec(_.qa())) {
            return a[1] + "." + a[2];
          }
        } else if (_.vc) {
          return (a = wm(/Android\s+([0-9.]+)/)) ? a : wm(/Version\/([0-9.]+)/);
        }
        return "";
      }();
    } catch (e) {
    ...
    try {
      ...
      _.zm = function () {
        ...
        (window.crypto || _.pc.msCrypto).getRandomValues(a);
        return a[0].toString(16) + a[1].toString(16);
      };
      _.Bm = function (a) {
        _.ym(window.parent, a, _.Am);
      };
      _.Im = function (a, b, c) {
        Cm
          ? _.y(
      ...
      Dm = function (a) {
        ...
        if ("string" === typeof a) return Jm(a);
        if (Array.isArray(a)) {
          for (var b = 0; b < a.length; b++) {
            if ("string" !== typeof a[b] || !Jm(a[b])) return !1;
          }
          return !0;
        }
        return !1;
      ...
      Jm = function (a) {
        try {
          ...
          a = c;
          b = "xb";
          if (Km.xb && Km.hasOwnProperty(b)) var d = Km.xb;
          else {
            var e = new Km();
            d = Km.xb = e;
          }
          a = a.split("").reverse().join("");
          var f = Lm(d.g, a), g = Lm(d.h, a);
          0 < g.length &&
      ...
      Fm = function () {
        Mm || (Mm = _.E(window, "message", function (a) {
          a = a.S;
          if (a.data) {
            var b = a.data;
      ...
      _.Qm = function (a) {
        _.Am ? _.Bm({ command: "intermediate_iframe_resize", height: a }) : _.y(
          "Resize command was not sent due to missing verified parent origin.",
        );
      };
      _.Rm = function () {
        _.Am ? _.Bm({ command: "intermediate_iframe_close" }) : _.y(
          "Close command was not sent due to missing verified parent origin.",
        );
      };
      _.Sm = function (a) {
        _.Am ? _.Bm({ command: "set_tap_outside_mode", cancel: a }) : _.y(
 ...
 SPDX-License-Identifier: Apache-2.0
      */
      ...
      var Um = function (a, b, c, d) {
        ...
        if (d && void 0 !== a.O) throw Error("va`" + b);
        a.O = c;
      };
      ...
      var Wm = function (a, b, c) {
        void 0 !== a.O && c.push(b);
        for (var d in a.g) Wm(a.g[d], b + d, c);
      };
      var Km = function () {
          this.g = Xm(
        ...
        Lm = function (a, b) {
          ...
          for (var g in a) {
            d = parseInt(g, 10),
              (d + 1 == b.length || "." == b.charAt(d + 1)) && 1 == a[g] &&
              d > c && (c = d);
          }
        ...
        Ym = function (a, b, c, d) {
          ...
          a++;
          if ("?" == e || "," == e) return a;
          do a = Ym(a, b, c, d), e = c.charAt(a); while ("?" != e && "," != e);
          return a + 1;
        };
      var Em, Mm, Cm, Gm, Hm;
      _.A("google.accounts.id.intermediate.verifyParentOrigin", _.Im);
      _.A("google.accounts.id.intermediate.notifyParentResize", _.Qm);
      _.A("google.accounts.id.intermediate.notifyParentClose", _.Rm);
      _.A("google.accounts.id.intermediate.notifyParentDone", function () {
        _.Am ? _.Bm({ command: "intermediate_iframe_done" }) : _.y(
          "Done command was not sent due to missing verified parent origin.",
        );
      });
      _.A("google.accounts.id.intermediate.notifyParentTapOutsideMode", _.Sm);
    } catch (e) {
      _._DumpException(e);
    }
    try {
      var Zm = function () {
        ...
        Z = function (a, b) {
          try {
            _.Fa("info") && window.console && window.console.info &&
              window.console.info(_.Ga(b) + a);
          } catch (c) {}
        },
        $m = function (a, b) {
          _.we(
        ...
        cn = function () {
          for (
            ...
            if (
              b = b.value, "google-signin-client_id" === b.getAttribute("name")
            ) {
        ...
        fn = function () {
          var a = _.zm().toString(), b = { Xb: 300, path: "/", Db: !0 }, c;
          if (c = _.ua()) c = 0 <= _.xd(_.xm, 80);
          c && (b.Cb = "none");
          c = _.ic(location.origin);
          "http" === c.h && "localhost" === c.g &&
            (b.Db = void 0, b.Cb = void 0);
          _.Ac.set("g_csrf_token", a, b);
          return a;
        },
        jn = function (a) {
          var b = void 0 === b ? "googleidentityservice" : b;
          if (!document.getElementById(b) || !gn[b]) {
            var c = new _.af(),
        ...
        mn = function (a, b, c, d) {
          d = void 0 === d ? !1 : d;
          var e = _.rc(document, "iframe");
          _.se(e, {
            src: b,
            id: c,
            title: "Sign in with Google Button",
            style:
              "display: block;position: relative;top: 0;left: 0;height: 0;width: 0;border: 0;",
          });
          if (d) {
            return b = _.rc(document, "div"),
              b.id = c + "-wrapper",
        ...
        pn = function (a) {
          var b = _.G("g_a11y_announcement");
          b ||
            (b = _.rc(document, "div"),
              b.id = "g_a11y_announcement",
              document.body.appendChild(b));
          var c = _.rc(document, "span");
          on(c, a);
          _.se(c, { role: "alert" });
          _.te(b);
          b.appendChild(c);
        ...
        un = function (a, b) {
          qn >= (void 0 === b ? 100 : b) ||
            (b = new _.Ub(rn),
              _.Xb(b, _.xe({ client_id: sn, as: tn, event: a.toString() })),
              _.we(
                b.toString(),
                void 0,
                "POST",
                ...
                void 0,
                void 0,
                "https://accounts.google.com/gsi/log" !== rn,
              ));
        },
        yn = function (a) {
          var b = new (Function.prototype.bind.apply(
            vn,
            [null, "onetap", a, "prompt"].concat(wn(xn.apply(1, arguments))),
          ))();
          un(b);
        },
        zn = function () {
        ...
        An = function () {
          var a = new (Function.prototype.bind.apply(
            vn,
            [null, "id", void 0, "init"].concat(wn(xn.apply(0, arguments))),
          ))();
          un(a);
        },
        Gn = function () {
          var a = _.G("g_id_onload");
          if (a) {
            var b = _.vm(a);
            a = _.rm(b, Bn);
            ...
            var c = {}, d;
            for (d in b) {
              b.hasOwnProperty(d) && 0 > Cn.indexOf(d.toLowerCase()) &&
                (c[d] = b[d]);
            }
            ...
            if (d = a.login_uri) {
              b = _.ic(d);
              b.g ||
                (_.Vb(b, location.protocol),
                  b.g = location.hostname,
                  _.Wb(b, location.port),
                  An("relativeLoginUri", d),
                  _.y(
              ...
              if ("https" !== b.h && "localhost" !== b.g) {
                throw An("unsecuredLoginUri", d),
                  new Dn("Unsecured login_uri provided.");
              }
              d = b.toString();
              a.login_uri = d;
            }
            d && !a.callback && (a.callback = En(d, c));
            "redirect" !== a.ux_mode || d ||
              _.z(
        ...
        En = function (a, b) {
          return function (c) {
            c && c.credential
              ? (b.credential = c.credential, b.g_csrf_token = fn(), _.Qk(a, b))
        ...
        Fn = function (a, b, c, d) {
          return function (e) {
            e && "password" === e.type
              ? (b[c] = e.id, b[d] = e.password, _.Qk(a, b))
        ...
        Mn = function (a) {
          a = new Jn(a);
          Kn.__G_ID_CLIENT__ = a;
          jn(a.ic);
          Ln(a);
          return a;
        },
        Nn = function (a, b, c) {
          var d = Kn.__G_ID_CLIENT__;
          d || (Mn(), d = Kn.__G_ID_CLIENT__);
          d.D(a, b, c);
        },
        Pn = function (a, b, c) {
          if (a && b) {
        ...
        Rn = function () {
          var a = Kn.__G_ID_CLIENT__;
          a || (Mn(), a = Kn.__G_ID_CLIENT__);
          Qn(a.o);
        },
        Sn = function () {
          ...
          try {
            ...
            if (d) {
              ...
              Mn(d);
              e && ("complete" === a ? Nn(f) : _.E(window, "load", function () {
                Nn(f);
              }, !1));
            }
            ...
            _.z(
              "Error parsing configuration from HTML: " +
                k.message,
            );
          }
        },
        Tn = function () {
          var a = Kn.onGoogleLibraryLoad;
          a && "function" === typeof a && a();
        },
        Un = function () {
          if (
            _.$e("enable_fedcm_via_userid") && _.wa() && _.ua() &&
            0 <= _.xd(Zm(), "101")
          ) {
            var a = document.createElement("meta");
            a.httpEquiv = "origin-trial";
            a.content =
              "A2TVWPxNQ54lPpfTQtUzD3to6g8p/4HAMgao5oG79IFFpstEoVBhPlvdoFj5zPRJpDhyzT3KDC4ptD2Fc9DjUgoAAABmeyJvcmlnaW4iOiJodHRwczovL2FjY291bnRzLmdvb2dsZS5jb206NDQzIiwiZmVhdHVyZSI6IkZlZENNIiwiZXhwaXJ5IjoxNjY0NTgyMzk5LCJpc1RoaXJkUGFydHkiOnRydWV9";
        ...
        Xn = function (a, b, c) {
          var d = c.client_id, e = c.scope, f = "code" === a ? "code" : "token";
          if ("code" === a) {
            var g = "offline";
          ...
          Wn(c, "access_type", g);
          Wn(c, "hd", n);
          Wn(c, "response_type", f);
          Wn(c, "include_granted_scopes", !1 === p ? "false" : "true");
          Wn(c, "enable_serial_consent", !1 === t ? "false" : "true");
          return b + "?" + c.join("&");
        },
        Zn = function (a, b) {
          if (!b.client_id) {
            throw new Yn("Missing required parameter client_id.");
          }
          if (!b.scope) throw new Yn("Missing required parameter scope.");
          var c = {
        ...
        $n = function () {
          ...
          if (a) {
            ...
            for (var c = a.next(); !c.done; c = a.next()) {
              ...
              !d && 0 <= d.indexOf(" ")
                ? (_.y(
                  "In hasGrantedAllScopes() method: invalid scope [" + c +
        ...
        ao = function (a) {
          return (a = a && a.scope && a.scope.trim())
            ? $n.apply(null, wn(a.split(" ")))
            : null;
        },
        bo = function (a) {
          _.ql(a, "prompt_closed", { hd: !1 });
        },
        co = function (a, b, c) {
          b = { nd: b };
          void 0 !=
              c && (b.oldHeight = c);
          _.ql(a, "prompt_resized", b);
        },
        wn = function (a) {
      ...
      _.J(go, _.O);
      var ho = { left: 1, center: 2 },
        io = { rectangular: 1, square: 3, pill: 2, circle: 4 },
        jo = { large: 1, medium: 2, small: 3 },
        ko = { signin: 1, signin_with: 2, signup_with: 3, continue_with: 4 },
        lo = { outline: 1, filled_blue: 2, filled_black: 3 },
        mo = { standard: 1, icon: 2 },
        no = function (a, b, c) {
          this.container = a;
          this.h = c;
          this.g = !1;
          a = new _.fi();
          b &&
            (b.logo_alignment && _.I(a, 6, ho[b.logo_alignment]),
              b.shape && _.I(a, 3, io[b.shape]),
              b.size && _.I(a, 1, jo[b.size]),
              b.text && _.I(a, 5, ko[b.text]),
              b.theme && _.I(a, 2, lo[b.theme]),
              b.type && _.I(a, 7, mo[b.type]),
              b.width && !isNaN(b.width) &&
              _.I(a, 4, b.width));
      ...
      vn.prototype.toString = function () {
        ...
        this.h && a.push.apply(a, wn(this.h));
        return a.join(".");
      };
      var qn = Math.floor(100 * Math.random()),
        rn = "https://accounts.google.com/gsi/log",
        sn,
        tn;
      var qo = [0, 7200, 86400, 604800, 2419200],
        ro = function (a, b, c) {
          this.i = a;
        ...
        to = function (a) {
          var b = so(a), c = {}, d = b[a.g + "p"];
          void 0 != d && (c.disable_auto_prompt = d);
          d = b[a.g + "t"];
          void 0 !== d && (c.disable_auto_select_to = d);
          a = b[a.g + "l"];
          c.prompt_suppress_level =
            "number" === typeof a && !isNaN(a) && 0 <= a && 4 >= a ? a : 0;
          return c;
        },
        uo = function (a, b) {
          var c = a.g + "p", d = a.g + "t", e = a.g + "l", f = so(a);
 ...
 SPDX-License-Identifier: Apache-2.0
      */
      ...
      var Do = function (a) {
          if (a instanceof Ao || a instanceof Bo || a instanceof Co) return a;
      ...
      Ao.prototype.za = function () {
        return new Bo(this.g());
      };
      Ao.prototype[Symbol.iterator] = function () {
      ...
      _.l.za = function (a) {
        var b = 0, c = this.g, d = new yo();
        d.next = function () {
          if (b >= c.length) return zo;
          var e = c.key(b++);
      ...
      Io.prototype.za = function (a) {
        var b = this.h[Symbol.iterator](), c = this, d = new yo();
        d.next = function () {
          var e = b.next();
          if (e.done) return e;
      ...
      var Jo = new _.pl("g_credential_picker"),
        Ko = ["bottom_sheet", "card"],
        Lo = ["signin", "signup", "use"],
        No = function (a, b) {
          b = void 0 === b ? "i_" : b;
          var c = new Ho();
          if (c.g) {
          ...
          this.v = d ? new Io(c, "g_state_id_") : null;
          this.xc = b;
          ...
          this.K = null;
          b = new Uint8Array(16);
          (window.crypto || _.pc.msCrypto).getRandomValues(b);
          this.A = btoa(String.fromCharCode.apply(String, wn(b))).replace(
            /=+$/,
            "",
          );
          this.C = {};
      ...
      var Mo = function (a, b) {
        ...
        if (c) Oo(a, c);
          ...
          if (c = void 0 !== b.log_level) {
            c = b.log_level, c = void 0 === c || 0 <= (0, _.za)(eo, c);
          }
          c && Oo(a, b.log_level);
        }
        a.yc = b.button_url || "https://accounts.google.com/gsi/button";
        a.xa = b.picker_url || "https://accounts.google.com/gsi/select";
        a.Ac = b.prompt_url || "https://accounts.google.com/gsi/iframe/select";
        a.Qa = b.status_url || "https://accounts.google.com/gsi/status";
        a.J = _.tm(a.Qa);
        a.ic = b.container_css_url || "https://accounts.google.com/gsi/style";
        a.Cc = b.revoke_url || "https://accounts.google.com/gsi/revoke";
        c = a.J;
        var d = b.client_id, e = a.A;
        rn = c ? c + "/gsi/log" : "https://accounts.google.com/gsi/log";
        sn = d;
        tn = e;
        a.callback = b.callback;
        a.fa = "redirect" === b.ux_mode ? "redirect" : "popup";
        c = b.ui_mode;
        void 0 != c && 0 <= (0, _.za)(Ko, c) ||
          (c = _.Gi() && !_.Hi() ? "bottom_sheet" : "card");
        a.uiMode = c;
        a.container = (b.prompt_parent_id
          ? document.getElementById(b.prompt_parent_id)
          : null) || document.body;
        a.zc = 9E4;
        a.U = !1 !== b.cancel_on_tap_outside;
        a.ia = !0 === b.itp_support;
        c = b.state_cookie_domain;
        !c || null != c && xo.test(c) || (c = void 0);
        a.o = new ro(c, a.xc, b.state_cookie_name);
        a.wa(b);
        c = {};
        ...
        c.ui_mode = a.uiMode;
        void 0 !== b.context && 0 <= (0, _.za)(Lo, b.context) &&
          (c.context = b.context);
        ...
        c.as = a.A;
        _.$e("rp_cancelable_auto_select") &&
          (c.feature = "cancelableAutoSelect");
        a.va(c);
        a.g = c;
      };
      No.prototype.wa = function () {};
      No.prototype.va = function () {};
      var Ln = function (a) {
          a.ja || (a.ja = !0,
            _.E(window, "message", function (b) {
              Po(a, b.S);
            }, !1),
            a.K = _.E(document, "click", function () {
              a.U && Qo(a, !1) && (Ro(a, "tap_outside"), zn("tapOutside"));
            }));
        },
        So = function (a) {
          navigator.credentials.get({
            ...
            var c = {};
            a.g.nonce && (c.nonce = a.g.nonce);
            b.login(c).then(function (d) {
              a.callback &&
                (d = { credential: d && d.idToken, select_by: "itp" },
                  a.callback.call(a, d),
                  _.x("FedCM response :" + JSON.stringify(d)));
            }, function (d) {
              _.z("FedCM login() rejects with " + d);
            });
          }, function (b) {
            _.z("FedCM get() rejects with " + b);
          });
        };
      No.prototype.D = function (a, b, c) {
        var d = this;
        Qo(this, !0) && (To(this, "flow_restarted"), zn("flowRestarted"));
        this.l = a;
        this.ga = c;
        ...
        this.g.client_id
          ? _.$e("unsupported_browser")
            ...
            : "FederatedCredential" in window &&
                window.FederatedCredential.prototype.login &&
                !window.location.pathname.includes("/legacy") &&
                _.Ki.enable_fedcm.includes(this.g.client_id) &&
                _.$e("enable_fedcm_via_userid")
            ? So(this)
            : Uo(this, function (e) {
              e && _.L(e, 3)
                ? (Vo(d), Wo(d), Xo(d, !0))
                ...
                ? (_.Gc(_.N(e, _.Ue, 2)),
                  ...
                  _.Xe(d, "prompt_display_failed", {
                    cause: "Error while checking for the credential status.",
                  }))
                : e && !_.L(e, 3) &&
                    (_.va() || _.Fi() || _.ya() && 0 <= _.xd(_.Bc(), "14.4")) &&
                    d.ia
                ? (Vo(d), Wo(d), Xo(d, !0))
                : e && !_.L(e, 3)
      ...
      var On = function (a, b, c, d) {
          ...
          a.C[e] = {
            ...
            handler: d,
            inline_button: b,
            data: { nonce: g.nonce || a.i.nonce, state: g.state || a.i.state },
          };
          delete g.nonce;
          delete g.state;
          d = _.xe(g);
        ...
        Yo = function (a, b, c, d) {
          var e = _.rc(document, "div");
          b.appendChild(e);
          b = new no(e, c, function () {
            Zo(a, d);
          });
          oo(b);
          return b;
            ...
            requestAnimationFrame(function () {
              requestAnimationFrame(function () {
                ...
                a: {
                  ...
                  e = performance && performance.timing &&
            ...
            d
              ? d.handler
                ...
                : (b = {},
                  ...
                  Qo(a, !0) &&
                  (To(a, "flow_restarted"), zn("buttonFlowStarted")),
                  d = Object.assign({}, a.i, b),
                  Mo(a, d),
                  "redirect" === a.fa
                    ? (a.g.login_uri ||
                      (a.g.login_uri = location.protocol + "//" +
                        location.host + location.pathname),
                      a.g.g_csrf_token = fn(),
                      a = _.Rk(_.Ok(a.xa, a.g)),
                      top.location.replace(_.Lk(a)))
                    : (a.m = _.zm(),
                      a.g.channel_id = _.Kc(a.m),
                      a.g.origin = a.g.origin || location.origin,
                      _.nl(_.Ok(a.xa, a.g), Jo) ||
                      un(
                        new vn("button", "popup", "clicked", "popupNotOpened"),
                      )))
      ...
      var Xo = function (a, b, c) {
        ...
        ap = function (a, b) {
          a.ga && a.ga.call(a, { type: b, message: void 0 });
        },
        Uo = function (a, b) {
          ...
          $m(c, function (d) {
            d && "null" !== d
              ...
              : (_.z("Check credential status returns invalid response."),
                a.j("unknown_reason"),
                _.Xe(a, "network", { cause: "invalid_response" }));
          });
        },
        Vo = function (a) {
          var b = a.g, c;
          if (c = a.g.auto_select) {
            ...
            d.disable_auto_select_to &&
              Date.now() >= d.disable_auto_select_to && (wo(c), d = to(c));
            c = !(d.disable_auto_select_to &&
          ...
          a.s = !0;
          a.Pa(b);
          _.ql(a, "prompt_displayed");
        };
      No.prototype.Pa = function (a) {
        ln(this.container, a, "bottom_sheet" === this.uiMode);
      };
      var Wo = function (a) {
          "bottom_sheet" === a.uiMode && window.setTimeout(function () {
            Qo(a, !1) && (Ro(a, "auto_cancel"), zn("autoCancel"));
          }, a.zc);
        },
        Po = function (a, b) {
          if (b.origin === a.J && b.data && "readyForConnect" === b.data.type) {
            if (
              ...
              if (c) {
                if (a.C[c]) {
                      ...
                      if ("command" !== f) {
                        ...
                        switch (f) {
                          ...
                          case "resize":
                            f = e.data.iframeId;
                            _.x(
                              "Resize command received for button: " + f + ".",
                            );
                            if (f) {
                              var h = e.data.height, k = e.data.width;
                              if (
                                (g = (g = document.getElementById(f)) &&
                  ...
                  try {
                    b.source.postMessage(d, a.J, [c.port2]);
                  } catch (e) {
                    _.z(
                ...
                b.data.channelId && a.m &&
                (a.m && _.Kc(a.m)) === b.data.channelId
              ) {
                c = new MessageChannel();
                c.port1.onmessage = function (e) {
                  a.P(e);
      ...
      No.prototype.P = function (a) {
        if (a.data && a.data.type) {
          switch (
            _.x("Message received: " + JSON.stringify(a.data)), a.data.type
          ) {
            case "response":
              var b = Qo(this, !0), c = a.data.response, d = c && c.credential;
              if (d) {
                var e = this.o, f = to(e);
              ...
              b && (d
                ? To(this, "credential_returned")
                : (Ro(this, "issuing_failed"), zn("issuingFailed")),
                bo(this));
              a.data.announcement && pn(a.data.announcement);
              break;
            case "activity":
              a.data.activity && this.bb(a.data.activity);
              break;
            case "command":
              if (b = a.data.command) {
                switch (b) {
                  case "close":
                    a.data.suppress &&
                      (a = this.o,
                        ...
                        b.disable_auto_prompt = (new Date()).getTime() +
                          1E3 * qo[b.prompt_suppress_level],
                        un(
                          new vn(
                            "onetap",
                            void 0,
                        ...
                        uo(a, b));
                    Qo(this, !0) &&
                      (Ro(this, "user_cancel"), bo(this), zn("userCancel"));
                    break;
                  case "resize":
                    a = a.data.height;
                    if (nn(a)) {
                      a: {
                        if (
                          ...
                          if (
                            d = b.getElementsByTagName("iframe"), 0 < d.length
                          ) {
                            d = d.item(0);
                            c = d.clientHeight;
                            b.style.height = a + "px";
                  ...
                  case "start_auto_select":
                    ap(this, "auto_select_started");
                    break;
                  case "cancel_auto_select":
                    Qn(this.o), ap(this, "auto_select_canceled");
                }
              }
          }
        }
      ...
      var bp = function (a, b, c) {
          var d = { successful: !1 }, e = a.g.client_id;
          e
            ? (b = { client_id: e, hint: b },
              a.A && (b.as = a.A),
              an(a.Cc, b, function (f) {
                if (f && "null" !== f) {
                  if (
                    f = new go(_.hd(f)),
                      d.successful = !!_.L(f, 3),
                      Z("Revoke XHR status: " + d.successful),
                      !d.successful
                  ) {
                    if (null != _.H(f, 2)) {
                      f = _.N(f, _.Ue, 2);
            ...
            : (_.z("Failed to revoke. Missing config parameter client_id."),
              c && (d.error = "missing_client_id", c(d)));
        },
        Oo = function (a, b, c) {
          (void 0 === c ? 0 : c) && a.v &&
            (b ? a.v.set("ll", b) : a.v.ob("ll"));
          _.Fc(b);
        };
      var Bn = {
          client_id: "str",
      ...
      var Jn = function (a) {
        ...
        this.ua = !1;
        this.G = !!this.h;
        this.ha = a && a.intermediate_iframe_close_callback;
        if (this.h && this.h) {
          if ("string" === typeof this.h) {
            if (!bn(this.h)) {
              ...
              for (a = 0; a < this.h.length; a++) {
                if ("string" !== typeof this.h[a] || !bn(this.h[a])) {
                  throw Error("ya");
                }
              }
            }
      ...
      _.J(Jn, No);
      Jn.prototype.wa = function (a) {
        this.B = a.native_callback;
      };
      Jn.prototype.j = function (a) {
        _.x("Prompt will not be displayed");
        this.B && cp(this);
        No.prototype.j.call(this, a);
      };
      var cp = function (a) {
        a.ua ||
          (a.ua = !0,
            "credentials" in navigator &&
            navigator.credentials.get({ password: !0, kd: "required" }).then(
              function (b) {
                a.B && a.B(b);
              },
            ));
      };
      Jn.prototype.D = function (a, b, c) {
        var d = this;
        this.G && this.h
          ? (_.x("Verifying parent origin."),
            _.Im(this.h, function () {
              _.Am ? _.Bm({ command: "set_ui_mode", mode: d.uiMode }) : _.y(
                "Set ui mode command was not sent due to missing verified parent origin.",
              );
              _.Sm(!1);
              d.ya = !1;
              No.prototype.D.call(d, a, b, c);
            }))
          : No.prototype.D.call(this, a, b, c);
      };
      Jn.prototype.P = function (a) {
        No.prototype.P.call(this, a);
        if (this.G && a.data && a.data.type) {
          switch (a.data.type) {
            case "response":
              a.data.response && a.data.response.credential &&
                (this.ya = !0, _.Qm(0));
              break;
            case "command":
              switch (a.data.command) {
                case "close":
                  this.ya ? _.Qm(0) : this.ha ? (_.Qm(0), this.ha()) : _.Rm();
                  break;
                case "resize":
                  a = a.data.height;
                  "number" === typeof a && !isNaN(a) && 0 < a && _.Qm(a);
                  break;
                case "cancel_protect_start":
                  _.Sm(!1);
                  break;
      ...
      Jn.prototype.Pa = function (a) {
        ln(this.container, a, "bottom_sheet" === this.uiMode, this.G);
      };
      Jn.prototype.va = function (a) {
        if (this.G) {
          switch (_.Om) {
      ...
      _.A("google.accounts.id.cancel", function () {
        var a = Kn.__G_ID_CLIENT__;
        a && Qo(a, !0) && (To(a, "cancel_called"), zn("cancel"));
      });
      _.A("google.accounts.id.disableAutoSelect", Rn);
      _.A("google.accounts.id.initialize", Mn);
      _.A("google.accounts.id.prompt", Nn);
      _.A("google.accounts.id.PromptMomentNotification", po);
      _.A("google.accounts.id.renderButton", Pn);
      _.A("google.accounts.id.revoke", function (a, b) {
        var c = Kn.__G_ID_CLIENT__;
        c ? bp(c, a, b) : _.z("Attempt to call revoke() before initialize().");
      });
      ...
      _.A("google.accounts.id.setLogLevel", function (a) {
        var b = Kn.__G_ID_CLIENT__;
        b || (Mn(), b = Kn.__G_ID_CLIENT__);
        a = a ? a.toLowerCase() : void 0;
        void 0 === a || 0 <= (0, _.za)(eo, a) ? Oo(b, a, !0) : (_.z(
      ...
      hp.prototype.requestCode = function () {
        var a = this.j;
        "redirect" === this.o
          ? (Z("Starting redirect flow.", "CODE_CLIENT"),
            a = _.Rk(Xn(this.h, this.i, a)),
            window.location.assign(_.Lk(a)))
          : (Z("Starting popup flow.", "CODE_CLIENT"),
            ep(this),
            fp(this, a),
            _.nl(Xn(this.h, this.i, a), gp));
      };
      var ip = new _.pl("g_auth_token_window"),
        jp = window,
        kp = function (a) {
          dp.call(this, "token", a);
          this.callback = a.callback;
      ...
      kp.prototype.l = function (a) {
        ...
        if (a.access_token) {
          if (jp.gapi && jp.gapi.client && jp.gapi.client.setToken) {
            try {
              jp.gapi.client.setToken.call(this, a);
            } catch (b) {
            ...
            _.y(
              "Set token failed. Gapi.client.setToken undefined.",
              "TOKEN_CLIENT",
            );
          }
        } else {
      ...
      kp.prototype.requestAccessToken = function (a) {
        var b = this.j;
        a = a || {};
        b = Zn(this.h, {
          client_id: b.client_id,
          ...
          hosted_domain: b.hosted_domain,
          include_granted_scopes: void 0 === a.include_granted_scopes
            ? b.include_granted_scopes
            : a.include_granted_scopes,
          enable_serial_consent: void 0 === a.enable_serial_consent
        ...
        ep(this);
        fp(this, b);
        _.nl(Xn(this.h, this.i, b), ip);
      };
      _.A("google.accounts.oauth2.initCodeClient", function (a) {
        return new hp(a);
      });
      _.A("google.accounts.oauth2.CodeClient", hp);
      _.A("google.accounts.oauth2.initTokenClient", function (a) {
        return new kp(a);
      });
      _.A("google.accounts.oauth2.TokenClient", kp);
      _.A("google.accounts.oauth2.hasGrantedAllScopes", function (a) {
        var b = xn.apply(1, arguments), c = ao(a);
        return c && c.length
          ? (b = $n.apply(null, wn(b))) && b.length
            ? (0, _.Oa)(b, function (d) {
              return 0 <= (0, _.za)(c, d);
            })
            : !1
